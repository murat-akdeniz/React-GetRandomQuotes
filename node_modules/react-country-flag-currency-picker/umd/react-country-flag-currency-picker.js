/*!
 * react-country-flag-currency-picker v1.0.1
 * MIT Licensed
 */
...
// CONCATENATED MODULE: ./src/countries-currency.js
/* harmony default export */ var countries_currency = ({
    "AF": {
        "name": "Afghanistan",
        "currency": "AFN",
        "symbol": '؋'
...
var src_ReactCountryFlagsCurrencySelect = function (_Component) {
	...
	function ReactCountryFlagsCurrencySelect(props) {
		...
		var defaultCountry = countries_currency[_this.props.defaultCountry] && _this.props.defaultCountry;
	...
	ReactCountryFlagsCurrencySelect.prototype.updateSelected = function updateSelected(countryCode) {
		var isValid = countries_currency[countryCode];
	...
	ReactCountryFlagsCurrencySelect.prototype.filterSearch = function filterSearch(evt) {
		...
		var filteredCountries = filterValue && this.state.countries.filter(function (key) {
			var label = _this2.props.customLabels[key] || countries_currency[key];
	...
	ReactCountryFlagsCurrencySelect.prototype.setCountries = function setCountries() {
		...
		var fullCountries = Object.keys(countries_currency);

		var selectCountries = this.props.countries && this.props.countries.filter(function (country) {
			return countries_currency[country].name;
		});
			...
			external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
				...
				isSelected && external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
					...
					this.props.showSelectedLabel && external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
						...
						this.props.customLabels[isSelected] || countries_currency[isSelected].name
					),
					this.props.showCurrency && external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
						'span',
						{ className: 'flag-select__option__label' },
						this.props.customLabels[isSelected] || countries_currency[isSelected].currency,
						' '
					),
					this.props.showCurrencySymbol && external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
						'span',
						{ className: 'flag-select__option__label' },
						this.props.customLabels[isSelected] || countries_currency[isSelected].symbol
					)
				),
				!isSelected && external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
					'span',
					...
					return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
						'li',
						{
							...
							onClick: function onClick() {
								return _this4.onSelect(countryCode, countries_currency[countryCode]);
							},
							onKeyUp: function onKeyUp(evt) {
						...
						external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
							...
							external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement('img', {
								...
								alt: 'flag for ' + countries_currency[countryCode].name,
							...
							_this4.props.showOptionLabel && external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
								'span',
								{ className: 'flag-select__option__label' },
								_this4.props.customLabels[countryCode] || countries_currency[countryCode].name
							),
							_this4.props.showCurrency && external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
								'span',
								{ className: 'flag-select__option__label' },
								_this4.props.customLabels[countryCode] || countries_currency[countryCode].currency
							),
							_this4.props.showCurrencySymbol && external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
								'span',
								{ className: 'flag-select__option__label' },
								_this4.props.customLabels[countryCode] || countries_currency[countryCode].symbol
							)
						)
					);
				})
...
src_ReactCountryFlagsCurrencySelect.defaultProps = {
	selectedSize: 16,
	optionsSize: 14,
...
src_ReactCountryFlagsCurrencySelect.propTypes = {
	...
	showCurrency: prop_types_default.a.bool,
	showCurrencySymbol: prop_types_default.a.bool
};

/* harmony default export */ var src = __webpack_exports__["default"] = (src_ReactCountryFlagsCurrencySelect);
